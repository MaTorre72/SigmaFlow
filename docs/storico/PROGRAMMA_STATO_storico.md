> **Archivio congelato (16/08/2026).** Cronologia completa del
> programma "Activity Log" + "modello caso/visita" (Fasi A-K, L1-L5,
> migrazione PROD), entrambi COMPLETATI e in produzione (deployment
> `@19`). Non viene piu' aggiornato: lo stato corrente vive nel nuovo
> `PROGRAMMA_STATO.md` snello in root del repo.
